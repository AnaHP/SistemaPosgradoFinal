...
class Controller {
    ...
    */
    function sendEmail($data, $template){
        ...
        $mail->Port = 587;
        //$mail->AddEmbeddedImage("../public/images/women.png", "logo");
        $mail->FromName = utf8_decode("WomenIT Facultad de Informática");
        $mail->AddAddress($data['correo']);
        $mail->IsHTML(true);
        $mail->Subject = utf8_decode($data['asunto']);
        $mail->addReplyTo('noreply@WomenIT.com', 'NoReply');
